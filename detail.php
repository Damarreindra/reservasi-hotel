                    ...
                    <div class="col-md-6">
                        <div class="product p-4">
                            ...
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"><?php echo $d->hotel ?></span>
                                ...
                                <div class="price d-flex flex-row align-items-center"> <span class="act-price">Rp.<?php echo $d->harga ?></span>
                            ...
                            <div class="w-25">
                                <label for="stok" class="form-label">Order</label>
