            ...
            <div class="col-md-10 mx-auto">
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <td><?= $row ["password"]; ?></td>
                         <td scope="row">
                                    <a href="ubah.php?op=edit&id=<?= $row["id_user"]; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="hapus.php?op=hapus&id=<?= $row["id_user"]; ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                </td>
                        </tr>
                        <?php $i++; ?>
                        <?php endforeach; ?>
